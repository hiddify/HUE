...
type HandlerServiceClient interface {
	AlterInbound(ctx context.Context, in *AlterInboundRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *handlerServiceClient) AlterInbound(ctx context.Context, in *AlterInboundRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type HandlerServiceServer interface {
	AlterInbound(context.Context, *AlterInboundRequest) (*emptypb.Empty, error)
...
func (UnimplementedHandlerServiceServer) AlterInbound(context.Context, *AlterInboundRequest) (*emptypb.Empty, error) {
